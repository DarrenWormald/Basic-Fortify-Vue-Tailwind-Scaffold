...
<template>
    <IsModal class="bg-white max-w-md p-12">
        ...
        <form class="mt-6 space-y-6" v-on:submit.prevent="submit">
            <p class="text-sm">
                To set up two factor authentication, scan the QR code with your
                authenticator application (Google Authenticator) and enter the
                code below.
            </p>
