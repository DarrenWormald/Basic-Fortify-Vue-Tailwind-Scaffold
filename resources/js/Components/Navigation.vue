            ...
            <div class="flex h-16 justify-between relative">
                    ...
                    <div class="flex justify-between w-full">
                        <div class="hidden sm:flex sm:ml-6 space-x-8">
                            <Link
                                ...
                                :class="{
                                    'border-blue-500':
                                        $page.props.ziggy.route_name == 'home',
                                }"
                ...
                >
                    ...
                    >
                        ...
                        <MenuItems
                            class="absolute right-0 z-10 mt-2 w-48 bg-white border border-b-slate-200 focus:outline-none"
                        >
                            <MenuItem
                                v-slot="{ active, close }"
                                v-if="
                            ...
                            <MenuItem
                                v-slot="{ active, close }"
                                v-if="$page.props.features.security"
                            >
                                <Link
                                    :onSuccess="close"
        ...
        <DisclosurePanel class="sm:hidden">
            <div class="spacey-1 pb-3">
                ...
                <Link
                    ...
                    :class="{
                        'border-blue-500':
                            $page.props.ziggy.route_name == 'dashboard',
                    }"
                    class="block py-2 px-8 font-medium text-gray-900 border-l-2 border-transparent"
                >
                    Dashboard
